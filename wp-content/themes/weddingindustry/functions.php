...
$nicdark_themename = "weddingindustry";
...
function nicdark_register_required_plugins() {
    ...
    $nicdark_plugins = array(
        ...
        //cf7
        array(
            'name'      => esc_html__( 'Contact Form 7', 'weddingindustry' ),
            'slug'      => 'contact-form-7',
            'required'  => true,
        ),
        ...
        //wp import
        array(
            'name'      => esc_html__( 'Wordpress Importer', 'weddingindustry' ),
        ...
        //nd shortcodes
        array(
            'name'      => esc_html__( 'ND Shortcodes', 'weddingindustry' ),
            'slug'      => 'nd-shortcodes',
            'required'  => true,
        ),
        ...
        //revslider
        array(
            'name'               => esc_html__( 'Revolution Slider', 'weddingindustry' ),
        ...
        //Visual Composer
        array(
            'name'               => esc_html__( 'Visual Composer', 'weddingindustry' ),
        ...
        //woocommerce
        array(
            'name'               => esc_html__( 'Woocommerce', 'weddingindustry' ),
    ...
    $nicdark_config = array(
        'id'           => 'weddingindustry',                 // Unique ID for hashing notices for multiple instances of TGMPA.
...
function nicdark_register_my_menus() {
  register_nav_menu( 'main-menu', esc_html__( 'Main Menu', 'weddingindustry' ) );  
}
...
function nicdark_add_sidebars() {
    ...
    register_sidebar(array(
        'name' =>  esc_html__('Sidebar','weddingindustry'),
        'id' => 'nicdark_sidebar',
...
function nicdark_customizer_logo( $wp_customize ) {
    ...
    $wp_customize->add_control( 
        new WP_Customize_Media_Control( 
            ...
            array(
              'label' => esc_html__( 'Logo', 'weddingindustry' ),
...
function nicdark_google_fonts_url() {
    $nicdark_font_url = '';
    if ( 'off' !== _x( 'on', 'Google font: on or off', 'weddingindustry' ) ) {
        $nicdark_font_url = add_query_arg( 'family', urlencode( 'Cinzel:400,700,900|Halant:300,400,700' ), "//fonts.googleapis.com/css" );
    }
